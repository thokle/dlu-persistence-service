...
namespace dlu_persistence_api.daos
{
    public class WebAnnonceKontrol
    {
        ...
        private string upDateSQL2 = "UPDATE tblAnnoncekontrol SET ErKontrolleret = 1  WHERE (MedieplanNr =@OrdreID) AND (UgeavisID =@BladID )";
        ...
        public int ManglerKontrol(int OrdreID)
        {
            try
            {
                ...
                return devEntities.Database.SqlQuery<int>(selectDistinct, new SqlParameter("OrdreID", OrdreID)).Single();
        ...
        public int AntaFejl(int OrdreID)
        {
            ...
            try
            {
                return devEntities.Database.SqlQuery<int>(selectCount, new SqlParameter("OrdreID", OrdreID)).Single();
        ...
        public byte SelectFakturing(int OrdreID)
        {
            ...
            try
            {
                return devEntities.Database.SqlQuery<byte>(selectMediePlan, new SqlParameter("OrdreID", OrdreID)).Single();
            }
            catch (SqlException ex)
            {
                throw new FormattedDbEntityValidationException(ex.InnerException);
